    ...
    def _setup_api(self):
        ...
        def score_texts():
            ...
            try:
                ...
                return jsonify(
                    {"scores": scores, "processing_time": processing_time, "cache_stats": self.cache.stats()}
                )
        ...
        def stats():
            ...
            return jsonify({"metrics": self.metrics, "cache_stats": self.cache.stats(), "model_mode": self.mode})
...
def main():
    ...
    parser.add_argument("--mode", choices=["stub", "real"], default="stub", help="Mode FinBERT: stub ou real")
    parser.add_argument("--port", type=int, default=5001, help="Port du serveur API")
