...
class VerificationService:
    ...
    def verify_decision(self, ticker: str, current_price: float, recommendation: str, fusion_score: float) -> Dict:
    ...
    def get_accuracy_stats(self, ticker: str, days: int = 7) -> Dict:
        ...
        try:
            ...
            if df.empty:
                return {"total_decisions": 0, "average_accuracy": 0, "coherent_decisions": 0, "accuracy_rate": 0}
