    ...
    def create_sentiment_chart(self, df: pd.DataFrame, ticker: str, period: str) -> go.Figure:
        ...
        try:
            ...
            fig.add_hline(y=30, line_dash="dash", line_color="green", 
                         annotation_text="ACHETER", annotation_position="top right")
            fig.add_hline(y=-30, line_dash="dash", line_color="red", 
                         annotation_text="VENDRE", annotation_position="bottom right")
    ...
    def create_prediction_chart(self, df: pd.DataFrame, prediction_data: Dict, ticker: str, period: str) -> go.Figure:
        ...
        try:
            ...
            if 'predictions' in prediction_data and prediction_data['predictions'] and \
               'prediction_dates' in prediction_data and prediction_data['prediction_dates']:
