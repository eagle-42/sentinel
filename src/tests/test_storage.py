...
class TestParquetStorage:
    ...
    def test_load_prices_existing(self):
        ...
        data = pd.DataFrame(
            {"ts_utc": pd.date_range("2024-01-01", periods=5, freq="1min"), "close": [100, 101, 99, 102, 98]}
        )
    ...
    def test_load_news_without_ticker(self):
        ...
        # Créer et sauvegarder des données
        data = pd.DataFrame(
            {"timestamp": pd.date_range("2024-01-01", periods=3, freq="1H"), "title": ["News 1", "News 2", "News 3"]}
        )
...
class TestDataStorage:
    ...
    def test_save_crawl_results(self):
        ...
        results = {
            "prices": {
                ...
                "NVDA": pd.DataFrame(
                    {"ts_utc": pd.date_range("2024-01-01", periods=5, freq="1min"), "close": [200, 201, 199, 202, 198]}
                ),
            },
            "news": [{"title": "News 1", "content": "Content 1"}, {"title": "News 2", "content": "Content 2"}],
            "crawl_time": 10.5,
        }
    ...
    def test_save_crawl_results_empty(self):
        ...
        results = {"prices": {}, "news": [], "crawl_time": 0}
    ...
    def test_error_handling_save_crawl_results(self):
        ...
        invalid_results = {"prices": "not a dict", "news": "not a list"}
