#!/usr/bin/env python3
"""
🧪 Script d'exécution des tests Sentinel2
...
class TestRunner:
    """Gestionnaire de tests Sentinel2 avec bonnes pratiques TDD"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Exécute les tests Sentinel2")
    parser.add_argument(
