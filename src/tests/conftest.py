"""
🧪 Configuration des tests Sentinel2
...
def test_data_dir() -> Path:
    ...
    return Path(tempfile.mkdtemp(prefix="sentinel2_test_"))


@pytest.fixture(scope="function")
def temp_dir() -> Generator[Path, None, None]:
    """Répertoire temporaire pour chaque test"""
    temp_path = Path(tempfile.mkdtemp(prefix="sentinel2_test_"))
    yield temp_path
    if temp_path.exists():
