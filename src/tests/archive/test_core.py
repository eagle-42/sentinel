...
class TestAdaptiveFusion:
    ...
    def test_add_signal(self):
        ...
        result = fusion.add_signal(price_signal=0.5, sentiment_signal=0.3, price_volatility=0.2, volume_ratio=1.2)
    ...
    def test_fusion_calculation(self):
        ...
        expected = fusion.current_weights["price"] * 0.5 + fusion.current_weights["sentiment"] * 0.3
...
class TestFinBertAnalyzer:
    ...
    def test_score_texts_stub(self):
        ...
        texts = ["NVIDIA stock is performing well", "Market crash expected", "Neutral market conditions"]
...
class TestLSTMPredictor:
    ...
    def test_prepare_features(self):
        ...
        data = pd.DataFrame({col: np.random.randn(100) for col in CONSTANTS.get_feature_columns()})
